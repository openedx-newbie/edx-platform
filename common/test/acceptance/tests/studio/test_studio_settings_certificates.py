...
class CertificatesTest(StudioCourseTest):
    ...
    def test_course_number_in_certificate_edit_view(self):
        """
        Scenario: Ensure that Course Number is displayed in certificate Edit view

        Given I have a certificate
        When I visit certificate details page on studio
        And click Edit Certificate button
        Then I see Course Number next to Course Name
        """
        self.certificates_page.visit()
        certificate = self.create_and_verify_certificate(
    ...
    def test_course_number_override_in_certificate_edit_view(self):
        """
        Scenario: Ensure that Course Number Override is displayed in certificate edit view
